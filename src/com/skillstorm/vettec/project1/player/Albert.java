...
public class Albert extends Player{
	...
	public String toString() {
		return "Albert is a kind older man, with only " + Albert.getPlayerEnergy() + " energy. However, he makes up for it with his " + Albert.getPlayerIntelligence() + " intelligence, and "
				+ Albert.getPlayerPatience() + " patience.";
	}
