...
public class Miranda extends Player {
	...
	public String toString() {
		return "Miranda is and intelligent and energtic player with " + Miranda.getPlayerEnergy() + " energy and "
				+ Miranda.getPlayerIntelligence() + " intelligence, however,"
				+ " she has a quick temper that can be set off if she loses her " + Miranda.getPlayerPatience()
				+ " patience.";
	}
